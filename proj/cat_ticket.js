...
ui.reset.on('click', function(){
    ...
    resetDialog.show();
    function Upgrade(){
        jsUrl = 'https://cdn.jsdelivr.net/gh/eliaszwc/eliaszwc.github.io/proj/cat_ticket.js'
        infoUrl = 'https://cdn.jsdelivr.net/gh/eliaszwc/eliaszwc.github.io/proj/info_ticket.json'
        toast('正在下载更新资源')
