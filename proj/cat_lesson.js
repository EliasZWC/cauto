...
ui.reset.on('click', function(){
    ...
    resetDialog.show();
    function Upgrade(){
        jsUrl = 'https://cdn.jsdelivr.net/gh/eliaszwc/eliaszwc.github.io/proj/cat_lesson.js'
        infoUrl = 'https://cdn.jsdelivr.net/gh/eliaszwc/eliaszwc.github.io/proj/info_lesson.json'
        toast('正在下载更新资源')
